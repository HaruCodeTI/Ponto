...
export async function POST(req: NextRequest) {
  try {
    ...
    const salaryCalculation = calculateProportionalSalary(monthlyCalculation, salaryConfig);

    // Formata valores monetários para exibição
    const formattedResult = {
      ...salaryCalculation,
      baseSalaryFormatted: formatCurrency(salaryCalculation.baseSalary),
      proportionalSalaryFormatted: formatCurrency(salaryCalculation.proportionalSalary),
      overtimeValueFormatted: formatCurrency(salaryCalculation.overtimeValue),
      nightShiftValueFormatted: formatCurrency(salaryCalculation.nightShiftValue),
      absencesDiscountFormatted: formatCurrency(salaryCalculation.absencesDiscount),
      latesDiscountFormatted: formatCurrency(salaryCalculation.latesDiscount),
      earlyDeparturesDiscountFormatted: formatCurrency(salaryCalculation.earlyDeparturesDiscount),
      totalDiscountsFormatted: formatCurrency(salaryCalculation.totalDiscounts),
      finalSalaryFormatted: formatCurrency(salaryCalculation.finalSalary),
    };
